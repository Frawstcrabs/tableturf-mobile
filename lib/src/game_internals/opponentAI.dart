...
enum AILevel {
  level1(xpAmount: 100, cashReward: 100),
  level2(xpAmount: 115, cashReward: 200),
  level3(xpAmount: 130, cashReward: 300);

  final int xpAmount;
  final int cashReward;

  const AILevel({required this.xpAmount, required this.cashReward});
